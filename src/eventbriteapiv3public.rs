// include!(concat!(env!("OUT_DIR"), "/eventbriteapiv3public.rs"));
...
#[derive(Debug, Serialize, Deserialize)]
pub struct image_logo {}

#[derive(Debug, Serialize, Deserialize)]
pub struct Venue {}

#[derive(Debug, Serialize, Deserialize)]
pub struct InstrumentTypeEnum {}

#[derive(Debug, Serialize, Deserialize)]
pub struct ConfirmationMessageUpdate {}

#[derive(Debug, Serialize, Deserialize)]
pub struct InstructionsUpdate {}

#[derive(Debug, Serialize, Deserialize)]
pub struct TicketGroupTickets {}

#[derive(Debug, Serialize, Deserialize)]
pub struct Triggers {}

#[derive(Debug, Serialize, Deserialize)]
pub struct PaymentMethodEnum {}
